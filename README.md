...
The repository is organized to help you easily find and follow along with the course materials.
  ...
  - **`lessons/utils/`**: Helper scripts and utility functions used in the notebooks.
