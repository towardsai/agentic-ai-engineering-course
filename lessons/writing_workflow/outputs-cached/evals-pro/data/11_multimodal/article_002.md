...
This lesson changes that. We will explore how to work with **multimodal data**—text, images, and documents—natively. We will move away from brittle OCR pipelines and learn how to feed visual data directly into LLMs. This unlocks critical real-world use cases, from analyzing medical documents with diagnostics to interpreting complex building sketches, financial reports, and technical diagrams.
...
Image 3: The two main approaches to developing multimodal LLM architectures. (Image by Sebastian Raschka from [Understanding Multimodal LLMs [1]](https://magazine.sebastianraschka.com/p/understanding-multimodal-llms))
...
Image 4: The unified embedding decoder architecture. (Image by Sebastian Raschka from [Understanding Multimodal LLMs [1]](https://magazine.sebastianraschka.com/p/understanding-multimodal-llms))
...
Image 5: The Cross-Modality Attention Architecture. (Image by Sebastian Raschka from [Understanding Multimodal LLMs [1]](https://magazine.sebastianraschka.com/p/understanding-multimodal-llms))
...
Image 6: Image tokenization and embedding (left) and text tokenization and embedding (right) side by side. (Image by Sebastian Raschka from [Understanding Multimodal LLMs [1]](https://magazine.sebastianraschka.com/p/understanding-multimodal-llms))
...
Image 7: A classic vision transformer (ViT) setup. (Image by Sebastian Raschka from [Understanding Multimodal LLMs [1]](https://magazine.sebastianraschka.com/p/understanding-multimodal-llms))
...
Image 8: Text and image embeddings mapped into a common space. (Image by Shawhin Talebi from [Multimodal Embeddings: An Introduction [3]](https://towardsdatascience.com/multimodal-embeddings-an-introduction-5dc36975966f/))
...
10. Finally, we can perform object detection directly on PDF pages. This is incredibly powerful for extracting diagrams or specific visual elements from technical papers.
    ...
    visualize_detections(response.parsed, Path("images") / "attention_is_all_you_need_1.jpeg")
    ```
    This works even for identifying diagrams within a PDF page, proving that we no longer need complex OCR pipelines to extract information from technical documents. The visualization function would display the PDF page with a red bounding box drawn precisely around the Transformer architecture diagram.
...
Image 11: The ColPali architecture. (Source [arXiv [6]](https://arxiv.org/pdf/2407.01449v6))

This bypasses the OCR bottleneck entirely. It captures layout, fonts, and visual elements that text-only models miss. On benchmarks like ViDoRe, ColPali significantly outperforms traditional OCR-based pipelines [[6]](https://arxiv.org/pdf/2407.01449v6).
...
5.  Let's test it.
    ...
    Description: This image is a detailed technical document, likely from a research paper...
    ```
...
1. Raschka, S. (2024, October 28). Understanding Multimodal LLMs. Ahead of AI. https://magazine.sebastianraschka.com/p/understanding-multimodal-llms

2. (n.d.). Vision Language Models. NVIDIA. https://www.nvidia.com/en-us/glossary/vision-language-models/

3. Talebi, S. (2024, November). Multimodal Embeddings: An Introduction. Towards Data Science. https://towardsdatascience.com/multimodal-embeddings-an-introduction-5dc36975966f/

4. Talebi, S. (2024, November 25). Multimodal Embeddings: An Introduction. YouTube. https://www.youtube.com/watch?v=YOvxh_ma5qE

5. (n.d.). Multi-modal ML with OpenAI's CLIP. Pinecone. https://www.pinecone.io/learn/series/image-search/clip/

6. Faysse, M., et al. (2024). ColPali: Efficient Document Retrieval with Vision Language Models. arXiv. https://arxiv.org/pdf/2407.01449v6

7. (n.d.). Image understanding with Gemini. Google AI for Developers. https://ai.google.dev/gemini-api/docs/image-understanding

8. (n.d.). Multimodal RAG with Colpali, Milvus and VLMs. Hugging Face. https://huggingface.co/blog/saumitras/colpali-milvus-multimodal-rag

9. (n.d.). Google Generative AI Embeddings (AI Studio & Gemini API). LangChain. https://python.langchain.com/docs/integrations/text_embedding/google_generative_ai/

10. (n.d.). LangGraph quickstart. LangChain. https://langchain-ai.github.io/langgraph/agents/agents/

11. (n.d.). Complex Document Recognition: OCR Doesn’t Work and Here’s How You Fix It. HackerNoon. https://hackernoon.com/complex-document-recognition-ocr-doesnt-work-and-heres-how-you-fix-it

12. (n.d.). What are some real-world applications of multimodal AI?. Milvus. https://milvus.io/ai-quick-reference/what-are-some-realworld-applications-of-multimodal-ai

13. (n.d.). What Is Optical Character Recognition (OCR)?. Roboflow. https://blog.roboflow.com/what-is-optical-character-recognition-ocr/

14. Guinness, H. (2025, May 23). The 8 best AI image generators in 2025. Zapier. https://zapier.com/blog/best-ai-image-generator/

15. (n.d.). The Hidden Ceiling: Why OCR is the bottleneck for RAG. Mixedbread. https://www.mixedbread.com/blog/the-hidden-ceiling