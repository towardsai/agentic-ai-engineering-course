...
class Settings(BaseSettings):
    ...
    # Application Default Credentials and GOOGLE_CLOUD_PROJECT. On Cloud Run, credentials
    # come from the runtime service account automatically.
        ...
        if self.google_genai_use_vertexai:
            if not self.google_cloud_project:
                raise RuntimeError(
                    ...
                    "(locally via `gcloud auth application-default login`; on Cloud Run the runtime "
