...
3. Repeat the following research loop for 3 rounds:
    ...
    3.2. Run the "run_web_research" tool with the new queries. It uses Perplexity by default and appends results to
    PERPLEXITY_RESULTS_FILE within NOVA_FOLDER. If the user explicitly requests Tavily, pass provider="tavily"
    instead. The original "run_perplexity_research" tool remains available for compatibility.
